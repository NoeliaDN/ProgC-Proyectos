...
namespace Clases
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            automovil1.Frenar//Una vez instanciado/ creado el objeto, ya podremos usar sus métodos y campos y al escribir "automovil1." VisualStudio nos sugerirá los campos y métodos que hemos creado ya en la clase.

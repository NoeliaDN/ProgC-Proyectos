...
namespace MetodoToStringModificadorOverride
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(automovil1.ToString()); // Al ejecutarlo nos muestra "MetodoToStringModificadorOverride.Automovil,", xq nos va a devolver el nombre completo del tipo object que hayamos colocado, es decir: el namespace + nombre de la clase
        }
